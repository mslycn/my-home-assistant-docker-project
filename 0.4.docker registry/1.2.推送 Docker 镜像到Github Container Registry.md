...
docker tag nextcloud:latest ghcr.io/mslycn/nextcloud:latest
~~~
...
docker tag rhasspy/wyoming-piper:2.2.2 ghcr.io/mslycn/wyoming-piper:2.2.2
...
docker push ghcr.io/mslycn/nextcloud:latest
docker push ghcr.io/mslycn/wyoming-piper:2.2.2
~~~
...
docker push ghcr.io/mslycn/rhasspy/wyoming-piper:2.2.2
~~~
...
step 2. goto package name

https://github.com/users/mslycn/packages/container/package/fun-asr

https://github.com/users/mslycn/packages/container/package/wyoming-piper

step 3. click  "Package settings"
...
https://github.com/users/mslycn/packages/container/nextcloud/settings
~~~
