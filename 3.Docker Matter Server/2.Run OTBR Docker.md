...
1. The HA team has done a lot of work getting their officially-supported container working under HAOS. I wouldn’t just expect that docker image to work outside of HAOS; that’s not what it was designed for. 
...
2. Stand-alone Home Assistant OpenThread Border Router docker container. For containerized home assistance setup without Yellow or HassOS.
